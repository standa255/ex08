void main(){
  ...
  print("------------------------"); 
  print ('''I don't understand what changes I should do concerning your code.'''); //your code: https://github.com/dzenanr/sliding_puzzle_wout_ui
  print ('''Furthermore "an efficient method for solving sliding-block puzzles would yield the most important result in computer science of all time"[1].''');
//[1] HEARN, Robert A. The Complexity of Sliding-Block Puzzles and Plank Puzzles. MIT computer science and artificial intelligence laboratory [online]. Available from: http://groups.csail.mit.edu/mac/users/bob/sliding-blocks.pdf
  print(" ");
  
  print("So I am not able to write a code which will solve the sliding-puzzles problem.");
  print("But I found some hints how to write such an algorithm[2]."); //[2]http://entertainment.howstuffworks.com/puzzles/sliding-puzzles3.htm
